...
_lr_productions = [
  ...
  ('fields -> FIELDNAME , FIELDNAME','fields',3,'p_fields','plt',383),
  ('fields -> fields , FIELDNAME','fields',3,'p_fields','plt',384),
  ('fields -> LBRACKET fields RBRACKET , FIELDNAME','fields',5,'p_fields','plt',385),
  ('fields -> LBRACKET fields , FIELDNAME','fields',4,'p_fields_error','plt',401),
  ('fields -> fields RBRACKET , FIELDNAME','fields',4,'p_fields_error','plt',402),
  ('action -> PLOTNAME WIDTH LBRACKET multi_style RBRACKET','action',5,'p_action','plt',414),
  ('action -> HIGHLIGHT INTEGER INTEGER style','action',4,'p_action','plt',415),
  ('action -> PLOTNAME WIDTH style','action',3,'p_action','plt',416),
  ('action -> PLOTNAME arguments','action',2,'p_action','plt',417),
  ('arguments -> arguments argument','arguments',2,'p_arguments','plt',455),
  ('arguments -> argument','arguments',1,'p_arguments','plt',456),
  ('argument -> WIDTH','argument',1,'p_argument','plt',467),
  ('argument -> DRAW_STYLE','argument',1,'p_argument','plt',468),
  ('argument -> COLOR','argument',1,'p_argument','plt',469),
  ('argument -> PLOTNAME','argument',1,'p_argument','plt',470),
  ('argument -> INTEGER','argument',1,'p_argument','plt',471),
  ('style -> DRAW_STYLE COLOR','style',2,'p_style','plt',480),
  ('multi_style -> DRAW_STYLE COLOR , DRAW_STYLE COLOR','multi_style',5,'p_multi_style','plt',486),
  ('multi_style -> multi_style , DRAW_STYLE COLOR','multi_style',4,'p_multi_style','plt',487),
]
